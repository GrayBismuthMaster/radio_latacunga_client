...
// import { TableComponentes } from '../../../../interfaces';
const editComponente = componentes.editComponente;


const EditComponente = (props:any) => {
    //const navigate = useNavigate();
    const location = useLocation();
    //const params = useParams();
    const {_id, nombre, area, email, estado, componentename, roles} = location.state.datosFila;
      ...
      <>
        <Formik
            ...
            onSubmit = {(values, )=>{
                ...
                props.editComponente( _id ,{...values, roles : roles});
                // resetForm();
            }}
        >
            {
                            ...
                            <div  className={styles.form_container_left_right}>    
                                <div className={styles.form_container}>
                                    ...
                                    <div className={styles.form_group}>
                                        ...
                                        />
                                        <label htmlFor="componentename" className={styles.form_label}>Componentename</label>
                                        <span className={styles.form_line}></span>
