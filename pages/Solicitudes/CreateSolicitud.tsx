...
const CreateSolicitud = (props : any) => {
    ...
    console.log("ref desde create solicitud ")
            ...
            <Formik
                ...
                onSubmit = {(values, {resetForm})=>{
                    ...
                    RadioLatacungaApi.post('/uploads/signS3',{
                        ...
                        await props.createSolicitud({ ... values, imagen : url});
                    })
                    // resetForm();
                }}
            >
                                ...
                                <div  className={styles.form_container_left_right}>    
                                    <div className={styles.form_container}>
                                        ...
                                        <div className={styles.form_group}>
                                            ...
                                            />
                                            <label htmlFor="solicitudname" className={styles.form_label}>Usuario</label>
                                            <span className={styles.form_line}></span>
