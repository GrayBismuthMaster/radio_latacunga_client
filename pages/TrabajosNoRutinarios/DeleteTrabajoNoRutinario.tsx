...
const  deleteTrabajoNoRutinario = trabajosNoRutinarios.deleteTrabajoNoRutinario
const DeleteTrabajoNoRutinario = ({deleteTrabajoNoRutinario }:any) => {
