...
import TrabajosNoRutinariosList from "./ReadTrabajosNoRutinariosList";
// import TrabajosNoRutinariosDetail from './ReadTrabajosNoRutinariosDetail';
    ...
    if(props.rol === 'admin'){
        return(
            <div style = {{
                ...
                <TrabajosNoRutinariosList/>
                {/* <TrabajosNoRutinariosDetail/> */}
            </div>
        )
    } else {
        return (
